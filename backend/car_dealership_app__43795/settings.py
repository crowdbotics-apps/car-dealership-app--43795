"""
Django settings for car_dealership_app__43795 project.
...
ROOT_URLCONF = 'car_dealership_app__43795.urls'
...
WSGI_APPLICATION = 'car_dealership_app__43795.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "car_dealership_app__43795 API",
    "DESCRIPTION": "API documentation for car_dealership_app__43795 App",
    "VERSION": "v1",
}
